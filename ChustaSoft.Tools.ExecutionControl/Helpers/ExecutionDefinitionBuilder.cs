...
{
    public class ExecutionDefinitionBuilder<TKey> : IExecutionDefinitionBuilder<TKey>, IBuilder<IEnumerable<ProcessDefinition<TKey>>>
    {
        ...
        public ExecutionDefinitionBuilder<TKey> Generate(Action<ProcessDefinitionBuilder<TKey>> definitionBuilder)
        {
    ...
    public class ExecutionDefinitionBuilder<TEnum, TKey> : ExecutionDefinitionBuilder<TKey>, IExecutionDefinitionBuilder<TEnum, TKey> where TEnum : struct, IConvertible
    {
        ...
        public ExecutionDefinitionBuilder<TKey> Generate(Action<ProcessDefinitionBuilder<TEnum, TKey>> definitionBuilder)
        {
            definitionBuilder.Invoke(_processDefinitionBuilder);
